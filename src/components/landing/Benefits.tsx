...
const ITEMS = [
  { icon: Wallet, title: "Economize de verdade", desc: "Compare preços e pague o menor sem perder cobertura." },
  { icon: Smartphone, title: "100% online", desc: "Cotação, contratação e apólice no seu celular." },
  { icon: Headphones, title: "Especialistas humanos", desc: "Time pronto para te ajudar quando precisar." },
      ...
      <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20">
        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {ITEMS.map((it) => (
            ...
            >
              <div className="grid h-11 w-11 place-items-center rounded-xl bg-cta text-cta-foreground">
