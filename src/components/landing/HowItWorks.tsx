    ...
    <section id="como-funciona" className="py-16 sm:py-20">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="mx-auto max-w-2xl text-center">
          <p className="text-xs font-semibold uppercase tracking-wider text-cta">Como funciona</p>
          <h2 className="mt-2 font-display text-3xl font-extrabold text-brand sm:text-4xl">
            Seguro auto, do jeito simples
          </h2>
        ...
        <ol className="mt-10 grid gap-4 sm:grid-cols-3">
          {STEPS.map((s, i) => (
            ...
            >
              <span className="absolute right-4 top-4 font-display text-4xl font-extrabold text-brand/10">
                0{i + 1}
              </span>
