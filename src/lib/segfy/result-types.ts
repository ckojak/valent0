export interface SegfyResult {
  ...
  installments_budget?: Array<{
    id?: string;
    name?: string;
    number_with_interests?: number[];
    [key: string]: unknown;
  }>;
  product: string;
  reference: string;
...
export interface SegfyCompanyCoverages {
  moral_damage?: number | string;
  body_injuries?: number | string;
  material_damage?: number | string;
  death?: number | string;
  invalidity?: string;
  glasses?: string;
  assistence?: string;
